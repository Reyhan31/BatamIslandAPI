...
use App\Models\PackageTripPanel2Content;
use Illuminate\Support\Facades\Storage;
class PackageTripPanel2ContentController extends Controller
{
    //
    ...
    public function store(Request $request)
    {
        ...
        $newFile = new PackageTripPanel2Content();
    ...
    {
        $file = PackageTripPanel2Content::latest()->first();
