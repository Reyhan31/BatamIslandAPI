...
use App\Models\PackageTripPanel1Content;
use Illuminate\Support\Facades\Storage;
class PackageTripPanel1ContentController extends Controller
{
    //
    ...
    public function store(Request $request)
    {
        ...
        $newFile = new PackageTripPanel1Content();
    ...
    {
        $file = PackageTripPanel1Content::latest()->first();
