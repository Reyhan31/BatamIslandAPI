...
use App\Models\HomeMembershipPanel;
use Illuminate\Support\Facades\Storage;

class HomeMembershipPanelController extends Controller
{
    //
    ...
    public function store(Request $request)
    {
        ...
        $newFile = new HomeMembershipPanel();
    ...
    {
        $file = HomeMembershipPanel::latest()->first();
