...
use App\Models\HomeTakeATourPanel;
use Illuminate\Support\Facades\Storage;

class HomeTakeATourPanelController extends Controller
{
    //
    ...
    public function store(Request $request)
    {
        ...
        $newFile = new HomeTakeATourPanel();
    ...
    {
        $file = HomeTakeATourPanel::latest()->first();
