...
use App\Models\AboutUsContentPanel;
use Illuminate\Support\Facades\Storage;
class AboutUsContentPanelController extends Controller
{
    //
    ...
    public function store(Request $request)
    {
        ...
        $newFile = new AboutUsContentPanel();
    ...
    {
        $file = AboutUsContentPanel::latest()->first();
